...
- [ ] 12. Author `.agents/WEB_OS_STANDARDS.md` utilizing exclusively affirmative, whitelist-based commands.
...
**Global OS State Management (`osState.ts`)**
...
**DOM Manipulation Actions (`use:action`)**
...
**System Navigation (Taskbar & Start)**
